...
class SmartChatbot:
    def __init__(self, model_path='chatbot_model.keras',
        ...
        self.responses = {str(idx): responses for idx, responses in enumerate(self.config['responses'])}
    ...
    # -----------------------------
    def get_response(self, intent_idx, **kwargs):
        intent_responses = self.responses[str(intent_idx)]
